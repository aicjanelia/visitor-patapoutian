...
function piezoAveragingIntermediate(dataDir,saveTag,filtZ,zThresh,pathSetup,spaPATH,spaBUILD,overwriteSweep)
...
disp(datestr(now))
[RR, I] = all2all3D_saveIntermediate(subParticles, scale, initAng, USE_GPU_GAUSSTRANSFORM, USE_GPU_EXPDIST,[dataDir saveTag '_IntermediateData.mat']);
disp(datestr(now))
