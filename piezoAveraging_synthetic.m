...
function piezoAveraging_synthetic(dataDir,saveTag,filtZ,zThresh,pathSetup,spaPATH,spaBUILD,overwriteSweep)
...
threshold = 2; % higher than with the real data!
...
%%
load([dataDir saveTag '_all2allIntermediate.mat'],'RR','I')
...
saveas(gcf,[dataDir 'iter5Sym_' saveTag '.png'],'png')
